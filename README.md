...
- **Tabs** — Cmd+T new tab, Cmd+W close tab; drag to reorder; right-click for "Close Tabs to the Right" / "Close Other Tabs"; unsaved tabs restored on relaunch; save prompt on close for modified named files
